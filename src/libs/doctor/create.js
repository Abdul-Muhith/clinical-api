import { DoctorModel, MemberModel } from "../../models/index.js";
import doctorValidate from "./validation.js";
import memberValidate from "../member/validation.js";
import { generateTraceId, dbCreateDocument } from "../../utils/index.js";
...
const create = async ({
  ...
  if (!isMemberExist) {
    ...
    const newMember = await dbCreateDocument(MemberModel, memberPayload);
    ...
    const newDoctor = await dbCreateDocument(DoctorModel, doctorPayload);
